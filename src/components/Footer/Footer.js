...
const Footer = () => {
    return (
        <footer className="bg-gray-800 text-white py-10">
            <div className='grid md:grid-cols-3 mx-auto w-4/5 md:w-3/4 items-center justify-center gap-4' >
                <div >
                ...
                <div >
                    <div className='' >
                        <div >
                            <Link to="/nasza-oferta" >Nasza Oferta</Link>
                ...
                <div className='flex gap-2 text-gray-300' >
                    ...
                    {/* button with smotth scrol to top */}
                    <button className='flex gap-1 items-center justify-center hover:text-white' onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} >
